...
public struct NavidromePodcastChannel: Identifiable, Hashable, Sendable {
    ...
    public var episodes: [NavidromePodcastEpisode] = []

    public init(id: String, title: String, description: String? = nil, coverArtID: String? = nil,
                url: String? = nil, episodes: [NavidromePodcastEpisode] = []) {
        self.id = id
        self.title = title
...
public struct NavidromePodcastEpisode: Identifiable, Hashable, Sendable {
    ...
    public init(id: String, title: String, description: String? = nil, publishDate: String? = nil,
                duration: Int? = nil, streamID: String? = nil, coverArtID: String? = nil, status: String? = nil) {
        self.id = id
        self.title = title
        self.description = description
    ...
    public var isPlayable: Bool { streamID != nil }
    ...
    public var isDownloadingOnServer: Bool { status?.lowercased() == "downloading" }
}
...
public struct PodcastsWire: Decodable {
    public let channel: [PodcastChannelWire]?
}

public struct PodcastChannelWire: Decodable {
    public let id: String
    public let title: String?
    public let description: String?
    public let coverArt: String?
    public let url: String?
    public let episode: [PodcastEpisodeWire]?

    public func toDomain() -> NavidromePodcastChannel {
...
public struct NewestPodcastsWire: Decodable {
    public let episode: [PodcastEpisodeWire]?
}

public struct PodcastEpisodeWire: Decodable {
    public let id: String
    public let title: String?
    public let description: String?
    public let publishDate: String?
    ...
    public func toDomain() -> NavidromePodcastEpisode {
