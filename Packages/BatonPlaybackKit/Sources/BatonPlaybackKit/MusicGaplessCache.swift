...
@MainActor
public final class MusicGaplessCache {
    private let directory: URL
    private let maxEntries: Int
    /// Byte budget: 6 raw FLACs can be hundreds of MB, so cap on size too, not just count.
    private let maxBytes: Int64

    public init(maxEntries: Int = 6, maxBytes: Int64 = 200 * 1024 * 1024, directory: URL? = nil) {
    ...
    public func store(tempFile: URL, songID: String) -> URL? {
    ...
    public func evictOld(keeping keepID: String? = nil) {
