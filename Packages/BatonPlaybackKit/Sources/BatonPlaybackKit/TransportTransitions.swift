...
public enum Crossfade {
    ...
    public static func inWindow(currentTime: Double, duration: Double, window: Double) -> Bool {
    ...
    public static func gains(step i: Int, of steps: Int, startOut: Float, targetIn: Float) -> (out: Float, in: Float) {
    ...
    public static let manualSkipSeconds: Double = 0.32
    ...
    public static let assumedStreamLatency: Double = 1.5
    ...
    public static let readinessTimeout: Double = 5.0
    ...
    public static func preRollWindow(window: Double, expectedLatency: Double, duration: Double) -> Double {
...
public enum GaplessPreload {
    ...
    public static func shouldPrefetch(wifiOnly: Bool, metered: Bool) -> Bool {
        !(wifiOnly && metered)
    }
    ...
    public static func preloadURL(stream: URL, cached: URL?) -> URL {
...
public enum Fade {
    ...
    public static func multiplier(step i: Int, of steps: Int, start: Float, target: Float) -> Float {
...
public enum PlaybackResume {
    /// Resume at `offset` only if it's past the first 2 s and before the last 5 s of `duration`.
    public static func shouldResume(offset: Double, duration: Double) -> Bool {
...
public enum TrackBoundary {
    ...
    public static func isAtEnd(currentTime: Double, duration: Double, tolerance: Double = 0.35) -> Bool {
