...
public enum MusicWebhookTokens {
    ...
    public static func song(_ song: NavidromeSong) -> [String: String] {
    ...
    public static func album(_ album: NavidromeAlbum) -> [String: String] {
        [
            "album": album.name,
            "artist": album.artist ?? "",
            "id": album.id,
    ...
    public static func artist(_ artist: NavidromeArtist) -> [String: String] {
        [
            "artist": artist.name,
            "id": artist.id,
    ...
    public static func playlist(_ playlist: NavidromePlaylist) -> [String: String] {
        [
