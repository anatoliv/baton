...
@MainActor
public protocol ScrobbleDestination: AnyObject {
...
@MainActor
public final class NavidromeScrobbleDestination: ScrobbleDestination {
    public init() {}

    public var destinationID: String { "navidrome" }
    ...
    public var isActive: Bool { NavidromeConfig.isConfigured }
    public var maxBatch: Int { 1 }
