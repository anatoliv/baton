...
extension StreamingPlaybackController {
    ...
    public enum Advance: Equatable { case replay, play(Int), stop }

    public static func onTrackEnd(current: Int, count: Int, repeatMode: RepeatMode) -> Advance {
    ...
    public static func onManualNext(current: Int, count: Int, repeatMode: RepeatMode) -> Advance {
        guard count > 0 else { return .stop }
