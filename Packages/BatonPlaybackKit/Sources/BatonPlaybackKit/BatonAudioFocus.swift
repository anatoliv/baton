...
@MainActor
public final class BatonAudioFocusRegistry {
    ...
    public static let handleMaxAge: TimeInterval = 10 * 60
    ...
    public nonisolated static func clampAgentDuck(_ percent: Int) -> Int {
    ...
    public func suspend(owner: String, on music: StreamingPlaybackController) -> [String: Any] {
    ...
    public func resume(handle: String, on music: StreamingPlaybackController) -> [String: Any] {
    ...
    @discardableResult
    public func expireHandles(forConnection connectionID: String, on music: StreamingPlaybackController) -> Int {
    ...
    @discardableResult
    public func expireStaleHandles(on music: StreamingPlaybackController) -> Int {
    ...
    public var liveHandleCount: Int { entries.values.filter { !$0.resolved }.count }
