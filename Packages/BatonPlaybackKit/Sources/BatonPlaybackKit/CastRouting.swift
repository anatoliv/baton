...
public struct CastRoute: Identifiable, Hashable, Sendable {
    ...
    public init(id: String, name: String, kind: Kind, isAvailable: Bool = true, isSelected: Bool = false) {
        self.id = id
        self.name = name
        self.kind = kind
...
public enum CastRouteResolver {
    ...
    public static func resolve(_ groups: [[CastRoute]]) -> [CastRoute] {
    ...
    public static func activeRoute(_ resolved: [CastRoute]) -> CastRoute? {
