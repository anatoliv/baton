...
extension StreamingPlaybackController {
    ...
    public static var loudnessHeadroom: Float { 0.5 } // ≈ -6 dB

    /// The effective `player.volume` multiplier for the loudness mode, including the headroom.
    public static func loudnessMultiplier(for song: NavidromeSong?, mode: LoudnessMode, preampDB: Double) -> Float {
    ...
    public static func normalizationGain(for song: NavidromeSong, mode: LoudnessMode, preampDB: Double) -> Float {
