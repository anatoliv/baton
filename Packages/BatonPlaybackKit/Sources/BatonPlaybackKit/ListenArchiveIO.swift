...
@MainActor
public protocol LocalListenRecording: AnyObject {
...
public struct PortableListen: Codable, Equatable {
    public var listened_at: Int
    public var track_metadata: Meta

    public struct Meta: Codable, Equatable {
        public var artist_name: String
        public var track_name: String
        public var release_name: String?

        public init(artist_name: String, track_name: String, release_name: String? = nil) {
    ...
    public init(listened_at: Int, track_metadata: Meta) {
        self.listened_at = listened_at
        self.track_metadata = track_metadata
    }

    public var artist: String { track_metadata.artist_name }
    public var track: String { track_metadata.track_name }
    public var album: String? { track_metadata.release_name }
    public var date: Date { Date(timeIntervalSince1970: TimeInterval(listened_at)) }
}
...
public enum ListenArchiveIO {
    // MARK: - Export

    /// A ListenBrainz-compatible JSON array (most-recent first), ready to write to a `.json` file.
    public static func exportJSON(_ listens: [PortableListen]) -> Data {
    ...
    public static func exportCSV(_ listens: [PortableListen]) -> String {
    ...
    public static func parse(_ data: Data) -> [PortableListen] {
    ...
    public static func syntheticID(artist: String, track: String) -> String {
