...
@MainActor
@Observable
public final class PodcastProgressStore {
    ...
    public struct ServerEpisode: Codable, Equatable, Identifiable, Sendable {
        ...
        public init(id: String, title: String, channel: String, coverArtID: String? = nil, duration: Double? = nil, seenAt: Date? = nil) {
            self.id = id
            self.title = title
    ...
    public static let serverEpisodeLimit = 2_000

    /// streamID → server episode. Kept in its own file so the progress format stays untouched.
    public private(set) var serverEpisodes: [String: ServerEpisode] = [:]
    ...
    public func isPlayed(id: String) -> Bool { progress[id]?.played ?? false }
    ...
    public func resumeOffset(id: String) -> Double? {
    ...
    public func remaining(id: String) -> Double? {
    ...
    public func isServerEpisode(_ id: String) -> Bool { serverEpisodes[id] != nil }
    ...
    public func inProgressServerEpisodes() -> [ServerEpisode] {
    ...
    public func registerServerEpisodes(_ episodes: [ServerEpisode]) {
        var changed = false
        let now = Date()
    ...
    @discardableResult
    public func record(id: String, position: Double, duration: Double?) -> Bool {
    ...
    public func inProgressIDs() -> [String] {
        progress
