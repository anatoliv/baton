    ...
    static let releases: [ReleaseNote] = [
        ReleaseNote(
            ...
            changes: [
                ...
                .init(.improved, "Transcribing a long podcast no longer holds the whole episode in memory while it uploads, and dragging an equalizer slider no longer allocates memory on the audio thread."),
