...
@MainActor
final class RemoteConversationLog {
    ...
    static func key(for inbound: RemoteInbound) -> String {
    ...
    func history(for key: String) -> [Turn] {
    ...
    func record(key: String, user: String, assistant: String) {
