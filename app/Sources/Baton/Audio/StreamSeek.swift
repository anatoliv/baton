...
enum StreamSeek {
    ...
    /// library is FLAC.
    static let nativelyPlayable: Set<String> = ["mp3", "m4a", "mp4", "aac", "alac", "wav", "aif", "aiff"]
    ...
    static func needsTranscode(suffix: String?) -> Bool {
    ...
    static let reachableTolerance: TimeInterval = 0.5
    ...
    static let spuriousEndTolerance: TimeInterval = 5.0
    ...
    static func isGenuineEnd(currentTime: TimeInterval, duration: TimeInterval) -> Bool {
    ...
    static let minimumOffset: TimeInterval = 1
    ...
    static func streamURL(_ url: URL, offset: TimeInterval = 0, transcode: Bool = true) -> URL {
